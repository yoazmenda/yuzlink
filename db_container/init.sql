...
insert into users (user_metadata_id) values ((select id from user_metadata where username = 'admin'));

insert into user_roles (role_id, user_id) values (
(select id from roles where role_name = 'ADMIN'),
(select id from user_metadata where username = 'admin')
);
...
insert into users (user_metadata_id) values ((select id from user_metadata where username = 'guest'));

insert into user_roles (role_id, user_id) values (
(select id from roles where role_name = 'GUEST'),
(select id from user_metadata where username = 'guest')
);